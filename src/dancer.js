...
var Dancer = function(top, left, timeBetweenSteps, step) {
...
class Dancer {
  ...
  step = () => setTimeout(this.step.bind(this), this.timeBetweenSteps);

  setPosition = (top, left) => this.$node.css({ top: top, left: left });
}
*/